...
class Analyzer
{
    ...
    public function __construct()
    {
        ...
        // 自定义词库
        $customWord = explode(PHP_EOL, file_get_contents(dirname(__FILE__) . '/../windIndexCore/dic/custom_dic.txt'));
        $this->customWord = array_flip((array)$customWord);

        // 自定义非词
        $notWord = explode(PHP_EOL, file_get_contents(dirname(__FILE__) . '/../windIndexCore/dic/not_word.txt'));
    ...
    {
        $this->dicMap = json_decode(file_get_contents(dirname(__FILE__) . '/../windIndexCore/dic/map_dic.dic'), true);
